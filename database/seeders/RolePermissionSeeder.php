...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role4 = Role::create(['name' => 'Tutor_Inmediato']);
        ...
        //permiso alto nivel
        Permission::create(['name' => 'high_level'])->syncRoles([$role0, $role5, $role6]);
        ...
        Permission::create(['name' => 'ver_usuarios'])->syncRoles([$role6, $role5, $role1, $role2]);

         //docentes
         Permission::create(['name'  => 'ver_docente'])->syncRoles([$role0, $role1, $role2, $role3, $role4,    $role5, $role6]);
         ...
         //Estudiantes
        Permission::create(['name' => 'ver_estudiante'])->syncRoles([$role2, $role1, $role5, $role6, $role0 ]);
        Permission::create(['name' => 'crear_estudiante'])->syncRoles([$role2, $role1, $role5, $role6 ]);
        Permission::create(['name' => 'editar_estudiante'])->syncRoles([$role2, $role1, $role5, $role6 ]);
        Permission::create(['name' => 'eliminar_estudiante'])->syncRoles([$role2, $role1, $role5, $role6 ]);
        Permission::create(['name' => 'subir_estudiante'])->syncRoles([$role2, $role1, $role5, $role6 ]);

        //tutor
        Permission::create(['name' => 'ver_tutor'])->syncRoles([$role0, $role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'crear_tutor'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'editar_tutor'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'eliminar_tutor'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'subir_tutor'])->syncRoles([$role1, $role2, $role5, $role6]);

        //notas
        Permission::create(['name' => 'registrar_nota'])->assignrole([$role1]);
        Permission::create(['name' => 'subir_nota'])->assignrole([$role1]);
        Permission::create(['name' => 'ver_Notas'])->syncRoles([$role1, $role2, $role3, $role4, $role5, $role6]);
        ...
        Permission::create(['name' => 'ver_pagos'])->syncRoles([$role0, $role1, $role2, $role3, $role4, $role5, $role6]);

        //asignaturas
        Permission::create(['name' => 'ver_asignaturas'])->syncRoles([$role5, $role6]);
        ...
        Permission::create(['name' => 'ver_horario'])->syncRoles([$role1, $role2, $role3, $role4, $role5, $role6]);
        ...
        //grados
        Permission::create(['name' => 'Ver_grados'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'Crear_grados'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'Editar_grados'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'Eliminar_grados'])->syncRoles([$role1, $role2, $role5, $role6]);
        Permission::create(['name' => 'Subir_grados'])->syncRoles([$role1, $role2, $role5, $role6]);

        //asignacion estudiantes - grado
        Permission::create(['name' => 'asignar_estudiante_grado'])->syncRoles([$role6, $role5, $role2]);
        Permission::create(['name' => 'ver_estudiante_grado'])->syncRoles([$role6, $role5, $role2, $role1, $role3, $role4]);
        ...
        Permission::create(['name' => 'ver_grado_docente_guia'])->syncRoles([$role5, $role6]);

         //asignacion materia - docente
         Permission::create(['name' => 'asignar_materia_docente'])->syncRoles([$role5, $role6]);
         Permission::create(['name' => 'ver_Materia_docente'])->syncRoles([$role1, $role2, $role3, $role4, $role5, $role6]);

         //evaluaciones - alumnos
        Permission::create(['name' => 'ver_evaluacion'])->syncRoles($role1, $role2, $role3,$role4, $role5, $role6);
        ...
        //quejas
        Permission::create(['name' => 'registrar_queja'])->assignrole($role4);
        Permission::create(['name' => 'editar_queja'])->assignrole($role4);
        Permission::create(['name' => 'ver_queja'])->syncRoles($role1, $role2, $role3,$role4, $role5, $role6);
