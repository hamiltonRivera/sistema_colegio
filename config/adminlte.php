    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Docente',
                    'url'  => 'private/admin/teachers',
                    'icon' => 'fas fa-users',
                    'can' => 'ver_docente'
                ],

                [
                    'text' => 'Materia - Docentes',
                    'url'  => 'private/admin/courses_teachers',
                    'icon' => 'fas fa-book-reader',
                    'can' => 'ver_Materia_docente'
                ],
                [
                    'text' => 'Año - Secciones',
                    'url'  => 'private/admin/grades',
                    'icon' => 'fas fa-font',
                    'can' => 'Ver_grados'
                ],
                [
